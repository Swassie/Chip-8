...
const int EMU_SPEED_HZ = 500;
const int EMU_SPEED_US = 1000000 / EMU_SPEED_HZ;
const int TIMER_HZ = 60;
const int TIMER_US = 1000000 / TIMER_HZ;

const uint8_t hexChars[80] = {0xF0, 0x90, 0x90, 0x90, 0xF0,
